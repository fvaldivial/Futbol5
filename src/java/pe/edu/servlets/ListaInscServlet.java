 ...
 * @author Rafael
 */
public class ListaInscServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        u = (UsuarioBean) request.getAttribute("usuario");
        
        String admin = u.getUsuario();
          
        PartidosDAO p = new PartidosDAO();
              
        List l = p.listarPartidosXUsuario(admin);
        
        request.setAttribute("usuario", request.getParameter("usuario"));
        System.out.println("este es el usuario " +request.getParameter("usuario"));
        request.setAttribute("partidosadmin", l);
